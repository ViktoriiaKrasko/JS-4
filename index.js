...
function compareCharCodeAtAndCodePointAt(string, index) {
  let charAtResult = string.charAt(index); // Використовуємо метод charAt(), щоб отримати символ з рядка на певній позиції, та запишемо результат в змінну charAtResult
  let atResult = string.at(index); // Використовуємо метод at(), щоб отримати символ з рядка на певній позиції, та запишемо результат в змінну atResult
  let charCodeAtResult = string.charCodeAt(index); // Використовуємо метод charCodeAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну charCodeAtResult
  let codePointAtResult = string.codePointAt(index); // Використовуємо метод codePointAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну codePointAtResult
